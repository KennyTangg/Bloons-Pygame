...
upgrademonkey = MonkeyMenu(upgrade_monkey_button,1150,60,True)
sellbutton = MonkeyMenu(sell_button,1150,110,True)
    ...
    if game_over == False:
        ...
        if selected_monkey:
            if selected_monkey.upgrade_level < 4:
                screen.blit(coin_image,(1140,10))
                draw_text("$100","white","black",1190,20)
